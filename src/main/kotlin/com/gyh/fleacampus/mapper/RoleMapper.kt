...
interface RoleMapper {
    ...
    fun insert(userId: Int, roleId: Int, unitId: Int): Int
    fun findAll(): List<Role>
    fun findIdByName(name: String): Int
    fun findByUserIdAndRoleId(userId: Int, roleId: Int): List<UserRole>
    fun removeRoleToUser(userId: Int, roleId: Int, unitId: Int): Int
    fun deleteById(id: Int): Int
    fun updateRoleById(id: Int, roleId: Int, unitId: Int): Int
    fun updateRoleByUserIdAndUnitId(userId: Int, roleId: Int, unitId: Int): Int
}